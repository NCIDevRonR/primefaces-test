...
public class ListingCtrlr implements Serializable {
    ...
    private void listingSequence(Map<String, String> parms) {
        runReport(parms);
    }
    
    
    
    private void runReport(Map<String, String> parms) {
        ...
        if (listingGenerated) {
            ...
            //  I have this poll object call in the app, and it seems to be still working to display the dialog.
...
//            PrimeFaces.current().executeScript("PF('poll').start();");
    ...
    //  The poll object calls this to stop itself after running once amd opening the dialog.
...
//    }
    ...
    public boolean execReport(Map<String, String> parms) {
        boolean result = true;
    ...
    private StreamedContent createStream(String filePath) {
    ...
    private StreamedContent getFileSystemPDF(String filePath, String simpleFilename) {
